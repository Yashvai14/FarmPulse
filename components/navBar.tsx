...
import { Sprout, Sun, Map, TrendingUp, Calendar } from 'lucide-react'; // ✅ Lucide icons
...
const NavBar = () => {
  ...
  return (
    <nav className="flex justify-center items-center py-8 p-4">
      <div
        className="flex justify-between shadow-xl py-4 px-6 rounded-4xl bg-white items-center"
        style={{ width: '1200px' }}
      >
        {/* Logo */}
            <div>
              ...
              <ul className="absolute top-8 left-0 bg-white shadow-lg rounded-xl py-2 w-72 z-50">
                <li>
                  ...
                  >
                    ...
                    <span>AI-Powered Crop Suggestions</span>
                  </Link>
                </li>
                <li>
                  <Link
                ...
                <li>
                  ...
                  >
                    ...
                    <span>Geo-Mapping for Farmland</span>
                  </Link>
                </li>
                <li>
                  <Link
                ...
                <li>
                  ...
                  >
                    ...
                    <span>Farming Calendar & Reminders</span>
                  </Link>
                </li>
              </ul>
            )}
